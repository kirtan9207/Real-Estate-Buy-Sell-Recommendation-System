...
def populate_db(csv_path='data/processed/final_dataset.csv'):
    ...
    DB_URL = os.getenv("DATABASE_URL", "postgresql://user:password@localhost:5432/real_estate")
    ...
    try:
        ...
        props_df.to_sql('properties', engine, if_exists='append', index=False, method='multi')
